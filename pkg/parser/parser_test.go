...
(PARTITION part0 VALUES LESS THAN (1) COMMENT = '1月份' ENGINE = InnoDB,
 ...
 PARTITION part11 VALUES LESS THAN (12) COMMENT = '12月份' ENGINE = InnoDB) */ ;`, true, "CREATE TABLE `app_channel_daily_report` (`id` BIGINT(20) NOT NULL AUTO_INCREMENT,`app_version` VARCHAR(32) COLLATE utf8_unicode_ci NOT NULL DEFAULT _UTF8MB4'default',`gmt_create` DATETIME NOT NULL COMMENT '创建时间',PRIMARY KEY(`id`)) ENGINE = InnoDB AUTO_INCREMENT = 33703438 DEFAULT CHARACTER SET = UTF8 DEFAULT COLLATE = UTF8_UNICODE_CI PARTITION BY RANGE (MONTH(`gmt_create`)-1) (PARTITION `part0` VALUES LESS THAN (1) COMMENT = '1月份' ENGINE = InnoDB,PARTITION `part1` VALUES LESS THAN (2) COMMENT = '2月份' ENGINE = InnoDB,PARTITION `part2` VALUES LESS THAN (3) COMMENT = '3月份' ENGINE = InnoDB,PARTITION `part3` VALUES LESS THAN (4) COMMENT = '4月份' ENGINE = InnoDB,PARTITION `part4` VALUES LESS THAN (5) COMMENT = '5月份' ENGINE = InnoDB,PARTITION `part5` VALUES LESS THAN (6) COMMENT = '6月份' ENGINE = InnoDB,PARTITION `part6` VALUES LESS THAN (7) COMMENT = '7月份' ENGINE = InnoDB,PARTITION `part7` VALUES LESS THAN (8) COMMENT = '8月份' ENGINE = InnoDB,PARTITION `part8` VALUES LESS THAN (9) COMMENT = '9月份' ENGINE = InnoDB,PARTITION `part9` VALUES LESS THAN (10) COMMENT = '10月份' ENGINE = InnoDB,PARTITION `part10` VALUES LESS THAN (11) COMMENT = '11月份' ENGINE = InnoDB,PARTITION `part11` VALUES LESS THAN (12) COMMENT = '12月份' ENGINE = InnoDB)"},
		...
		{"ALTER TABLE t ADD VECTOR INDEX ((VEC_COSINE_DISTANCE(a))) USING SPFresh COMMENT 'a'", true, "ALTER TABLE `t` ADD VECTOR INDEX((VEC_COSINE_DISTANCE(`a`))) USING SPFRESH COMMENT 'a'"},
		{"ALTER TABLE t ADD VECTOR INDEX idx ((VEC_COSINE_DISTANCE(a))) USING SPFresh COMMENT 'a'", true, "ALTER TABLE `t` ADD VECTOR INDEX `idx`((VEC_COSINE_DISTANCE(`a`))) USING SPFRESH COMMENT 'a'"},
		{"ALTER TABLE t ADD VECTOR INDEX idx USING SPFresh ((VEC_COSINE_DISTANCE(a))) COMMENT 'a'", true, "ALTER TABLE `t` ADD VECTOR INDEX `idx`((VEC_COSINE_DISTANCE(`a`))) USING SPFRESH COMMENT 'a'"},
		{"ALTER TABLE t ADD VECTOR INDEX IF NOT EXISTS idx ((VEC_COSINE_DISTANCE(a))) USING SPFresh", true, "ALTER TABLE `t` ADD VECTOR INDEX IF NOT EXISTS `idx`((VEC_COSINE_DISTANCE(`a`))) USING SPFRESH"},
		...
		{"CREATE INDEX idx ON t (a) USING SPFresh", true, "CREATE INDEX `idx` ON `t` (`a`) USING SPFRESH"},
		...
		{"CREATE VECTOR INDEX idx ON t ((VEC_COSINE_DISTANCE(a))) USING SPFresh", true, "CREATE VECTOR INDEX `idx` ON `t` ((VEC_COSINE_DISTANCE(`a`))) USING SPFRESH"},
		{"CREATE VECTOR INDEX idx ON t ((VEC_COSINE_DISTANCE(a))) USING SPFresh COMMENT 'c'", true, "CREATE VECTOR INDEX `idx` ON `t` ((VEC_COSINE_DISTANCE(`a`))) USING SPFRESH COMMENT 'c'"},
		{"CREATE VECTOR INDEX idx USING SPFresh ON t ((VEC_COSINE_DISTANCE(a)))", true, "CREATE VECTOR INDEX `idx` ON `t` ((VEC_COSINE_DISTANCE(`a`))) USING SPFRESH"},
		{"CREATE VECTOR INDEX IF NOT EXISTS idx ON t ((VEC_COSINE_DISTANCE(a))) USING SPFresh", true, "CREATE VECTOR INDEX IF NOT EXISTS `idx` ON `t` ((VEC_COSINE_DISTANCE(`a`))) USING SPFRESH"},
		{"CREATE VECTOR INDEX IF NOT EXISTS idx ON t ((VEC_COSINE_DISTANCE(a))) TYPE SPFresh", true, "CREATE VECTOR INDEX IF NOT EXISTS `idx` ON `t` ((VEC_COSINE_DISTANCE(`a`))) USING SPFRESH"},
		...
		{"create table t(a int, b vector(3), vector index((VEC_COSINE_DISTANCE(b))) USING SPFresh);", true, "CREATE TABLE `t` (`a` INT,`b` VECTOR(3),VECTOR INDEX((VEC_COSINE_DISTANCE(`b`))) USING SPFRESH)"},
		{"create table t(a int, b vector(3), vector index idx((VEC_COSINE_DISTANCE(b))) USING SPFresh);", true, "CREATE TABLE `t` (`a` INT,`b` VECTOR(3),VECTOR INDEX `idx`((VEC_COSINE_DISTANCE(`b`))) USING SPFRESH)"},
		{"create table t(a int, b vector(3), vector index if not exists idx((VEC_COSINE_DISTANCE(b))) USING SPFresh);", true, "CREATE TABLE `t` (`a` INT,`b` VECTOR(3),VECTOR INDEX IF NOT EXISTS `idx`((VEC_COSINE_DISTANCE(`b`))) USING SPFRESH)"},
		{"create table t(a int, b vector(3), vector index idx USING SPFresh ((VEC_COSINE_DISTANCE(b))));", true, "CREATE TABLE `t` (`a` INT,`b` VECTOR(3),VECTOR INDEX `idx`((VEC_COSINE_DISTANCE(`b`))) USING SPFRESH)"},
		{"create table t(a int, b vector(3), vector index idx TYPE SPFresh ((VEC_COSINE_DISTANCE(b))));", true, "CREATE TABLE `t` (`a` INT,`b` VECTOR(3),VECTOR INDEX `idx`((VEC_COSINE_DISTANCE(`b`))) USING SPFRESH)"},
