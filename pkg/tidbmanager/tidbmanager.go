...
const (
	...
	// DefaultTimeout is the default timeout for the manager client.
	DefaultTimeout = 10 * time.Second
)

// Client is the client to communicate with the manager server.
type Client interface {
	// Free notifies the manager the pod is ready to be reused.
